...
|---|---|---|---|---|
| [openai/codex](https://github.com/openai/codex) | CODE 引擎黑盒与 app-server 协议参考 | Apache-2.0 | `codex-upstream/` | `44918ea10c0f99151c6710411b4322c2f5c96bea` / `rust-v0.144.1` |
