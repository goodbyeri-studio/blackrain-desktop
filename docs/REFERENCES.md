...
| 项目 | 用途 | 许可证 | 本地路径 | 锁定版本 |
|---|---|---|---|---|
| [openai/codex](https://github.com/openai/codex) | **CODE 引擎**(强编码);参考其 `codex-rs` 的 skills / AGENTS.md / app-server-protocol / 沙箱 | Apache-2.0 | `codex-upstream/` | `51b3cd5`(2026-06-09) |
