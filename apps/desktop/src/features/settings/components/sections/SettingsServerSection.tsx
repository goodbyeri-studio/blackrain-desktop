    ...
    <SettingsSection
      ...
      subtitle={
        isMobileSimplified
          ...
          : tx("Configure how BlackRain exposes TCP backend access for mobile and remote clients. Desktop usage remains local unless you explicitly connect through remote mode.")
      }
    >
      ...
      <>
        ...
        {!isMobileSimplified && (
          <SettingsToggleRow
            ...
            subtitle={tx("If disabled, BlackRain stops managed TCP daemon processes before exit.")}
          >
            <SettingsToggleSwitch
        ...
        <div className="settings-field">
          ...
          <div className="settings-help">
            {isMobileSimplified
              ? tx("Use the Tailscale host from your desktop BlackRain app (Server section), for example `macbook.your-tailnet.ts.net:4732`.")
      ...
      <div className="settings-help">
        {isMobileSimplified
          ? tx("Use your own infrastructure only. On iOS, get the Tailscale hostname and token from your desktop BlackRain setup.")
          : tx("Mobile access should stay scoped to your own infrastructure (tailnet). BlackRain does not provide hosted backend services.")}
      </div>
      {addRemoteOpen && (
        <ModalShell
