...
describe("UpdateToast", () => {
    ...
    const { container } = render(
      <UpdateToast
        ...
        postUpdateNotice={{
          stage: "loading",
          version: "1.2.3",
          htmlUrl: "https://github.com/goodbyeri-studio/blackrain-desktop/releases/tag/v0.7.69",
        }}
  ...
  it("renders post-update release notes and opens GitHub link", () => {
    const onDismissPostUpdateNotice = vi.fn();
    const htmlUrl =
      "https://github.com/goodbyeri-studio/blackrain-desktop/releases/tag/v0.7.69";
    const state: UpdateState = { stage: "idle" };
