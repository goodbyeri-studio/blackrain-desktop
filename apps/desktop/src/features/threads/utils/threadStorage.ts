...
const STORAGE_KEY_THREAD_ACTIVITY = "blackrain.threadLastUserActivity";
export const STORAGE_KEY_PINNED_THREADS = "blackrain.pinnedThreads";
export const STORAGE_KEY_CUSTOM_NAMES = "blackrain.threadCustomNames";
export const STORAGE_KEY_THREAD_CODEX_PARAMS = "blackrain.threadCodexParams";
export const STORAGE_KEY_DETACHED_REVIEW_LINKS = "blackrain.detachedReviewLinks";
