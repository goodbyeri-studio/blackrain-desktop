...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            codex::delete_thread,
            codex::thread_items_list,
            codex::thread_background_terminals_list,
            codex::thread_background_terminals_terminate,
            codex::environment_info,
            codex::skills_config_write,
            codex::skills_extra_roots_set,
            codex::hooks_list,
            codex::plugin_list,
            codex::plugin_installed,
            codex::plugin_read,
            codex::plugin_install,
            codex::plugin_uninstall,
            codex::plugin_skill_read,
            codex::marketplace_add,
            codex::marketplace_remove,
            codex::marketplace_upgrade,
            codex::thread_search,
            codex::thread_goal_get,
            codex::thread_goal_clear,
            codex::thread_goal_set,
            codex::thread_memory_mode_set,
            codex::memory_reset,
            codex::thread_unarchive,
            codex::thread_loaded_list,
            codex::thread_shell_command,
            codex::thread_background_terminals_clean,
            codex::thread_settings_update,
            codex::thread_metadata_update,
            codex::thread_approve_guardian_denied_action,
            codex::model_provider_capabilities_read,
            codex::experimental_feature_enablement_set,
            codex::permission_profile_list,
            codex::account_logout,
            codex::mcp_server_oauth_login,
            codex::mcp_resource_read,
            codex::mcp_server_tool_call,
            codex::windows_sandbox_setup_start,
            codex::windows_sandbox_readiness,
            codex::external_agent_config_detect,
            codex::external_agent_config_import,
            codex::external_agent_config_import_histories_read,
