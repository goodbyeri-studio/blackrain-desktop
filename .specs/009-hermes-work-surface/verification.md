...
- MCP 的 verified runtime 解析、配置注册/注销策略和上游 `tools/list_changed` contract 已有代码/单测证据；真实 BlackRain 启动 MCP 子进程、environment value 注入、跨 activation 切换和 Windows process-tree 清理仍未验证。
