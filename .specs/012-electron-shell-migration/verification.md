...
| 2026-07-30 | CI 门禁 | workflow 静态审阅 + YAML parse | 已接线 | Node 22 Windows job 覆盖 package、无重复 package 的 smoke/E2E 和 make；Gateway 路径独立触发 Python 3.13 unittest；需在远端 CI 实际运行后登记 PASS |
