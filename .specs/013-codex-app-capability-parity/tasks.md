...
- [x] 完整复核三份 2026-07-26 Codex App Browser 研究稿
...
- [ ] daemon 将 app-server server request 双向转发到 main，并支持 cancel/deadline
...
- [ ] 固定 Browser client hash，并验证 token/endpoint 不进入 renderer、thread 或日志
...
- [ ] 实现 page WebContents/renderer/daemon/App restart 恢复和 stale generation/revision 拒绝
...
- [ ] renderer/page WebContents/daemon 重启、隐藏运行和 App restart 恢复验证
...
- [ ] 决策 BlackRain 自有 Browser skill/client 与 P0 dynamic-tool adapter 的去留
