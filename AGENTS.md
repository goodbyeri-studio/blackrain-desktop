...
工作台、Session Orchestrator、专家市场和 OPC/工作室均已暂停。不得把它们写成当前产品第一主语、当前里程碑或近期交付承诺。历史品牌名不属于当前产品入口。
...
| `plugins/` | 实验性适配器归档 | 不进入 Codex-first 主链，不扩建插件市场 |
| `workbenches/` | 实验性工作台归档 | 冻结，不进入当前产品主线 |
...
[NOTICE](NOTICE) 与 [开源项目说明](docs/open-source.md)。
